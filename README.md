...
<a href="https://pkg.go.dev/github.com/Munchpass/checkbook"><img src="https://pkg.go.dev/badge/github.com/Munchpass/checkbook.svg" alt="Go Reference"></a>
...
```sh
go get -u 'github.com/Munchpass/checkbook@v0.0.1'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/Munchpass/checkbook/option).
...
We are keen for your feedback; please open an [issue](https://www.github.com/Munchpass/checkbook/issues) with questions, bugs, or suggestions.

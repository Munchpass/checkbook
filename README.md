...
<a href="https://pkg.go.dev/github.com/stainless-sdks/checkbook-go"><img src="https://pkg.go.dev/badge/github.com/stainless-sdks/checkbook-go.svg" alt="Go Reference"></a>

<!-- x-release-please-end -->

The Checkbook Go library provides convenient access to the Checkbook REST API
...
```go
import (
	"github.com/stainless-sdks/checkbook-go" // imported as checkbook
)
```
...
```sh
go get -u 'github.com/stainless-sdks/checkbook-go@v0.0.1'
```
...
The checkbook library uses the [`omitzero`](https://tip.golang.org/doc/go1.24#encodingjsonpkgencodingjson)
...
See the [full list of request options](https://pkg.go.dev/github.com/stainless-sdks/checkbook-go/option).
...
`*checkbook.Error`. This contains the `StatusCode`, `*http.Request`, and
...
We also provide a helper `checkbook.File(reader io.Reader, filename string, contentType string)`
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/checkbook-go/issues) with questions, bugs, or suggestions.

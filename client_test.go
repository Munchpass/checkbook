...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Account.Bank.List(context.Background())
	if userAgent != fmt.Sprintf("Checkbook/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Account.Bank.List(context.Background())
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Account.Bank.List(cancelCtx)
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Account.Bank.List(deadlineCtx)
		if err == nil {
